import"../chunks/DsnmJJEf.js";import{p as l,q as c,x as v,b as f}from"../chunks/Ce8YuaDY.js";import{s as m,u,a as d}from"../chunks/BA8C_d9j.js";import{E as g}from"../chunks/CnhhIgOv.js";import{f as p,i as x,r as n}from"../chunks/BX_KVGA7.js";import{h as t}from"../chunks/VSDcwp7L.js";const h=`uniform vec2 resolution;
uniform float time;
...
}`;function $(e,o){l(o,!0);const[i,r]=m(),a=()=>d(n,"$run",i);c(()=>{p.set(h),x.set(!1),n.set(u(n,a()))});const s=v([{line:41,message:"有機的な動きを表現する関数"},...t(42,55),...t(68,69),...t(81,85)]);g(e,{title:"有機的な動き",get highlightLines(){return s}}),f(),r()}export{$ as component};
